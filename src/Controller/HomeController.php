...
private function getProductsByCategory(string $categoryName): array
{
    ...
    {
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Management books']);
        $products = $productRepository->findBy(['category' => $category]);
    ...
    public function iphoneindex(ProductRepository $productRepository): Response
    {
        ...
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Skill book']);
        $products = $productRepository->findBy(['category' => $category]);
    ...
    {
        // Lấy danh sách sản phẩm của category "macbook"
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Political book']);
        $products = $productRepository->findBy(['category' => $category]);
